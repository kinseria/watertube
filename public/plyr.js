  ...
  (function (e, t) {
    ...
    var nt = {
      ...
      setQualityMenu: function (e) {
        ...
        if (G(this.elements.settings.panels.quality)) {
          ...
          if (
            (nt.toggleMenuButton.call(this, i, a),
            fe(n),
      ...
      setCaptionsMenu: function () {
        ...
        if (G(this.elements.settings.panels.captions)) {
          var t = "captions",
            ...
            a = Boolean(n.length);
          if (
            (nt.toggleMenuButton.call(this, t, a),
            fe(i),
            nt.checkMenu.call(this),
            a)
          ) {
            var s = n.map(function (t, n) {
              return {
                ...
                badge:
                  t.language &&
                  nt.createBadge.call(e, t.language.toUpperCase()),
                list: i,
                type: "language",
              };
            });
            ...
            xe.call(
              ...
              function (e) {
                (G(n.player.elements.controls) &&
                  ...
                  n.player.listeners.proxy(e, n.toggle, "fullscreen");
              }
            ),
            xe.call(
              this,
                  ...
                  this.bind(
                    ...
                    function (e) {
                      ...
                      if (!ee(e) || 39 === n || 37 === n) {
                        ...
                        s && r
                          ? (i.removeAttribute(a), De(t.play()))
                          : !r &&
                            t.playing &&
                            (i.setAttribute(a, ""), t.pause());
                      }
                    }
                  ),
                  oe.isIos)
    ...
    var Tt = {
      ...
      ready: function () {
        ...
        i.customControls ||
          Je(Ue(t.config.urls.vimeo.api, p)).then(function (e) {
            !ae(e) &&
              e.thumbnail_url &&
              yt.setPoster.call(t, e.thumbnail_url).catch(function () {});
          }),
